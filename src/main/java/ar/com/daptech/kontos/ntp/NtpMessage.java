package ar.com.daptech.kontos.ntp;
...
/** *//**
    ...
    public String toString() {
        ...
        return "Leap indicator: " + leapIndicator + " " + "\nVersion: " + version + " " + "\nMode: " + mode + " " + "\nStratum: " + stratum + " " + "\nPoll: " + pollInterval + " " + "\nPrecision: " + precision + " (" + precisionStr + " seconds) " + "Root delay: " + new DecimalFormat("0.00").format(rootDelay * 1000) + " ms " + "Root dispersion: " + new DecimalFormat("0.00").format(rootDispersion * 1000) + " ms " + "Reference identifier: " + referenceIdentifierToString(referenceIdentifier, stratum, version) + " " + "\nReference timestamp: " + timestampToString(referenceTimestamp) + " " + "\nOriginate timestamp: " + timestampToString(originateTimestamp) + " " + "\nReceive timestamp:   " + timestampToString(receiveTimestamp) + " " + "\nTransmit timestamp:  " + timestampToString(transmitTimestamp);
    }
