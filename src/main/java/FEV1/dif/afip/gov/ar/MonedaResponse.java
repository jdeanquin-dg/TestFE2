...
public class MonedaResponse  implements java.io.Serializable {
    private FEV1.dif.afip.gov.ar.Moneda[] resultGet;
    ...
    public MonedaResponse(
           FEV1.dif.afip.gov.ar.Moneda[] resultGet,
     ...
     * @return resultGet
     */
    public FEV1.dif.afip.gov.ar.Moneda[] getResultGet() {
        return resultGet;
    }
     ...
     * @param resultGet
     */
    public void setResultGet(FEV1.dif.afip.gov.ar.Moneda[] resultGet) {
        this.resultGet = resultGet;
    }
