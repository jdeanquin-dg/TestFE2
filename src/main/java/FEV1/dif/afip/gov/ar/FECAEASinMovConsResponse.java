...
public class FECAEASinMovConsResponse  implements java.io.Serializable {
    private FEV1.dif.afip.gov.ar.FECAEASinMov[] resultGet;
    ...
    public FECAEASinMovConsResponse(
           FEV1.dif.afip.gov.ar.FECAEASinMov[] resultGet,
     ...
     * @return resultGet
     */
    public FEV1.dif.afip.gov.ar.FECAEASinMov[] getResultGet() {
        return resultGet;
    }
     ...
     * @param resultGet
     */
    public void setResultGet(FEV1.dif.afip.gov.ar.FECAEASinMov[] resultGet) {
        this.resultGet = resultGet;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getResultGet() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getResultGet(), i);
                if (obj != null &&
