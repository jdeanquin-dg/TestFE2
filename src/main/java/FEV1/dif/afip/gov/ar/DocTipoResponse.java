...
public class DocTipoResponse  implements java.io.Serializable {
    private FEV1.dif.afip.gov.ar.DocTipo[] resultGet;
    ...
    public DocTipoResponse(
           FEV1.dif.afip.gov.ar.DocTipo[] resultGet,
     ...
     * @return resultGet
     */
    public FEV1.dif.afip.gov.ar.DocTipo[] getResultGet() {
        return resultGet;
    }
     ...
     * @param resultGet
     */
    public void setResultGet(FEV1.dif.afip.gov.ar.DocTipo[] resultGet) {
        this.resultGet = resultGet;
    }
