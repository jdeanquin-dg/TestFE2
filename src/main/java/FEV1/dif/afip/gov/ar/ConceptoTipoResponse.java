...
public class ConceptoTipoResponse  implements java.io.Serializable {
    private FEV1.dif.afip.gov.ar.ConceptoTipo[] resultGet;
    ...
    public ConceptoTipoResponse(
           FEV1.dif.afip.gov.ar.ConceptoTipo[] resultGet,
     ...
     * @return resultGet
     */
    public FEV1.dif.afip.gov.ar.ConceptoTipo[] getResultGet() {
        return resultGet;
    }
     ...
     * @param resultGet
     */
    public void setResultGet(FEV1.dif.afip.gov.ar.ConceptoTipo[] resultGet) {
        this.resultGet = resultGet;
    }
