...
public class FETributoResponse  implements java.io.Serializable {
    private FEV1.dif.afip.gov.ar.TributoTipo[] resultGet;
    ...
    public FETributoResponse(
           FEV1.dif.afip.gov.ar.TributoTipo[] resultGet,
     ...
     * @return resultGet
     */
    public FEV1.dif.afip.gov.ar.TributoTipo[] getResultGet() {
        return resultGet;
    }
     ...
     * @param resultGet
     */
    public void setResultGet(FEV1.dif.afip.gov.ar.TributoTipo[] resultGet) {
        this.resultGet = resultGet;
    }
