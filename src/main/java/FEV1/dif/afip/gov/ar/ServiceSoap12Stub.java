...
public class ServiceSoap12Stub extends org.apache.axis.client.Stub implements FEV1.dif.afip.gov.ar.ServiceSoap {
    ...
    private static void _initOperationDesc1(){
        ...
        param.setOmittable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "CAEA"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), String.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "PtoVta"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"), int.class, false, false);
        oper.addParameter(param);
    ...
    private static void _initOperationDesc2(){
        ...
        param.setOmittable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "MonId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), String.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
 ...
 try {        Object _resp = _call.invoke(new Object[] {auth, feCAEReq});
  ...
  throw axisFaultException;
    ...
    public FEV1.dif.afip.gov.ar.FERegXReqResponse FECompTotXRequest(FEV1.dif.afip.gov.ar.FEAuthRequest auth) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {auth});
 ...
 try {        Object _resp = _call.invoke(new Object[] {});
  ...
  throw axisFaultException;
    ...
    public FEV1.dif.afip.gov.ar.FERecuperaLastCbteResponse FECompUltimoAutorizado(FEV1.dif.afip.gov.ar.FEAuthRequest auth, int ptoVta, int cbteTipo) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {auth, new Integer(ptoVta), new Integer(cbteTipo)});
  ...
  throw axisFaultException;
    ...
    public FEV1.dif.afip.gov.ar.FECompConsultaResponse FECompConsultar(FEV1.dif.afip.gov.ar.FEAuthRequest auth, FEV1.dif.afip.gov.ar.FECompConsultaReq feCompConsReq) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {auth, feCompConsReq});
  ...
  throw axisFaultException;
    ...
    public FEV1.dif.afip.gov.ar.FECAEAResponse FECAEARegInformativo(FEV1.dif.afip.gov.ar.FEAuthRequest auth, FEV1.dif.afip.gov.ar.FECAEARequest feCAEARegInfReq) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {auth, feCAEARegInfReq});
  ...
  throw axisFaultException;
    ...
    public FEV1.dif.afip.gov.ar.FECAEAGetResponse FECAEASolicitar(FEV1.dif.afip.gov.ar.FEAuthRequest auth, int periodo, short orden) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {auth, new Integer(periodo), new Short(orden)});
  ...
  throw axisFaultException;
    ...
    public FEV1.dif.afip.gov.ar.FECAEASinMovConsResponse FECAEASinMovimientoConsultar(FEV1.dif.afip.gov.ar.FEAuthRequest auth, String CAEA, int ptoVta) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {auth, CAEA, new Integer(ptoVta)});
  ...
  throw axisFaultException;
    ...
    public FEV1.dif.afip.gov.ar.FECAEASinMovResponse FECAEASinMovimientoInformar(FEV1.dif.afip.gov.ar.FEAuthRequest auth, int ptoVta, String CAEA) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {auth, new Integer(ptoVta), CAEA});
 ...
 try {        Object _resp = _call.invoke(new Object[] {auth, new Integer(periodo), new Short(orden)});
  ...
  throw axisFaultException;
    ...
    public FEV1.dif.afip.gov.ar.FECotizacionResponse FEParamGetCotizacion(FEV1.dif.afip.gov.ar.FEAuthRequest auth, String monId) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {auth, monId});
