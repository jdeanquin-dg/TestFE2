...
public class CbteTipoResponse  implements java.io.Serializable {
    private FEV1.dif.afip.gov.ar.CbteTipo[] resultGet;
    ...
    public CbteTipoResponse(
           FEV1.dif.afip.gov.ar.CbteTipo[] resultGet,
     ...
     * @return resultGet
     */
    public FEV1.dif.afip.gov.ar.CbteTipo[] getResultGet() {
        return resultGet;
    }
     ...
     * @param resultGet
     */
    public void setResultGet(FEV1.dif.afip.gov.ar.CbteTipo[] resultGet) {
        this.resultGet = resultGet;
    }
