...
public class FECotizacionResponse  implements java.io.Serializable {
    private FEV1.dif.afip.gov.ar.Cotizacion resultGet;
    ...
    public FECotizacionResponse(
           FEV1.dif.afip.gov.ar.Cotizacion resultGet,
     ...
     * @return resultGet
     */
    public FEV1.dif.afip.gov.ar.Cotizacion getResultGet() {
        return resultGet;
    }
     ...
     * @param resultGet
     */
    public void setResultGet(FEV1.dif.afip.gov.ar.Cotizacion resultGet) {
        this.resultGet = resultGet;
    }
