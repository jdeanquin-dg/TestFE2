...
public class OpcionalTipoResponse  implements java.io.Serializable {
    private FEV1.dif.afip.gov.ar.OpcionalTipo[] resultGet;
    ...
    public OpcionalTipoResponse(
           FEV1.dif.afip.gov.ar.OpcionalTipo[] resultGet,
     ...
     * @return resultGet
     */
    public FEV1.dif.afip.gov.ar.OpcionalTipo[] getResultGet() {
        return resultGet;
    }
     ...
     * @param resultGet
     */
    public void setResultGet(FEV1.dif.afip.gov.ar.OpcionalTipo[] resultGet) {
        this.resultGet = resultGet;
    }
