...
public class IvaTipoResponse  implements java.io.Serializable {
    private FEV1.dif.afip.gov.ar.IvaTipo[] resultGet;
    ...
    public IvaTipoResponse(
           FEV1.dif.afip.gov.ar.IvaTipo[] resultGet,
     ...
     * @return resultGet
     */
    public FEV1.dif.afip.gov.ar.IvaTipo[] getResultGet() {
        return resultGet;
    }
     ...
     * @param resultGet
     */
    public void setResultGet(FEV1.dif.afip.gov.ar.IvaTipo[] resultGet) {
        this.resultGet = resultGet;
    }
